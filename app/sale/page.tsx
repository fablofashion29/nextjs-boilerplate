...
export const metadata = {
  title: "Sale — Fablo Fashion",
  description: "Sale — Fablo Fashion — sustainable, stylish clothing",
};

export default function SalePage() {
  return (
    <main className="max-w-3xl mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold mb-4">Our Sale</h1>
      <p className="text-gray-700 mb-6">
        Discover our curated collection of sustainable fashion pieces on sale.
